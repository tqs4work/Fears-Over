...
public class PlayerTestMap3 : MonoBehaviour
{
        ...
        if (!isDead)
        {
            if (!isBlock)
            {
                ...
                if (Input.GetKeyDown(KeyCode.Space) && isGround == true && stamina >= 10)
                {
                    ...
                    audioMap3.GetComponent<AudioMap3>().jumpSource.Play();

                    stamina -= 10;
                }

                if (transform.position.y < -0.6) isGround = true;
                else isGround = false;
                ...
                if (Time.time >= nextAttackTime)
                {
                    ...
                    {
                        audioMap3.GetComponent<AudioMap3>().attackSource.Play();
                        ...
                        foreach (Collider2D enemy in hitEnemies)
                        {
                            ...
                            if (enemy.CompareTag("Boss")) enemy.GetComponent<BossTestMap3>().TakeDame(20);

                            if (enemy.CompareTag("Arrow"))
                            {
                                audioMap3.GetComponent<AudioMap3>().hitSource.Play();
                ...
                if (Time.time >= nextDashTime)
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.LeftShift) && isDash == false && stamina >= 35)
                    {
                        ...
                        audioMap3.GetComponent<AudioMap3>().dashSource.Play();
                        moveSpeed = 30f;
            ...
            if (hp < 0)
            {
                ...
                audioMap3.GetComponent<AudioMap2>().c1Source.Stop();
                audioMap3.GetComponent<AudioMap2>().c2Source.Stop();
                audioMap3.GetComponent<AudioMap2>().bgSource1.Stop();
                audioMap3.GetComponent<AudioMap2>().deadSource.Play();
            }
        }
